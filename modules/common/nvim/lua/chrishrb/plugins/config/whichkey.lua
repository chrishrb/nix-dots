...
which_key.add({
  ...
  { "<leader>f", "<cmd>lua require('telescope.builtin').find_files(require('telescope.themes').get_dropdown{hidden = true, previewer = false})<cr>", desc = "Find files", nowait = true, remap = false },
  { "<leader>h", "<cmd>nohlsearch<CR>", desc = "No Highlight", nowait = true, remap = false },
  { "[d", "<cmd>lua vim.diagnostic.goto_prev()<cr>", desc = "Previous Diagnostic" },
  { "]d", "<cmd>lua vim.diagnostic.goto_next()<cr>", desc = "Next Diagnostic" },

  -- Hidden
  { "<leader>r", "<cmd>lua vim.lsp.buf.rename()<CR>", desc = "Rename variable", nowait = true, remap = false, hidden = true },
  { "<leader>n", "<cmd>lua vim.lsp.buf.code_action()<CR>", desc = "Codeaction", nowait = true, remap = false, hidden = true },
  ...
  -- LSP
  {
    ...
    { "<leader>ld", "<cmd>Trouble diagnostics toggle<cr>", desc = "Diagnostics (Trouble)", nowait = true, remap = false },
    { "<leader>lf", "<cmd>lua vim.lsp.buf.formatting()<cr>", desc = "Format", nowait = true, remap = false },
    { "<leader>ll", "<cmd>lua vim.lsp.codelens.run()<cr>", desc = "CodeLens Action", nowait = true, remap = false },
    { "<leader>lr", "<cmd>Trouble lsp toggle<cr>", desc = "LSP Definitions / Refences / ... (Trouble)", nowait = true, remap = false },
    { "<leader>lq", "<cmd>Trouble quickfix list<cr>", desc = "Qucikfix List (Trouble)", nowait = true, remap = false },
  },
