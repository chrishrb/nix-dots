...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Christoph"
    user-mail-address "ch.herb@gmx.de")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/cherb/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/cherb/bin" "/profile/bin" "/Users/cherb/.npm-packages/bin" "/Users/cherb/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
